...
public interface IContainer {
     ...
     */
    void addFactory(String name, IGlobalFactory factory);
     ...
     */
    IGlobalFactory replaceFactory(String name, IGlobalFactory newFactory);
     ...
     */
    IGlobalFactory getFactory(String name);
     ...
     */
    Map<String, IGlobalFactory> getFactories();
     ...
     */
    Object instance(String name, Object... parameters);
